    ...
    <div>
      <div className="flex flex-row justify-between p-5 md:px-32 px-5 bg-darkBackground text-white">
        <div className="flex items-center">
          ...
          >
            <h1 className="font-semibold text-xl cursor-pointer">TriPedia</h1>
          </Link>
        </div>
      ...
      <div
        ...
        } lg:hidden flex flex-col absolute bg-darkBackground text-white left-0 top-25 font-semibold text-2xl text-center pt-8 pb-4 gap-4 w-full h-fit transition-transform duration-300`}
      >
        <Link
          to="home"
          spy={true}
